    ...
    <div class="all" style="width: 80%;margin:0 auto;margin-top: 10px">
        ...
        <div class="main">
            <div class="left" style="width: 70%">
                ...
                <!--                                    <div class="block"><el-avatar :size="50" src="https://shadow.elemecdn.com/app/element/hamburger.9cf7b091-55e9-11e9-a976-7f4d0b07eef6.png"></el-avatar></div>-->
                <!--                                </div>-->
                <!--                                <div class="tweet-user-name">-->
                <!--                                    <div style="font-size: 17px;font-weight: bold;">曹隆翔</div>-->
                <!--                                    <div style="font-size: 13px;color: #99a2aa;">2020-10-26</div>-->
                <!--                                </div>-->
                <!--                            </div>-->
                <!--                            <div class="weiquan"><img src="../../styles/weiquan.png" height="50px" width="auto"/></div>-->
                <!--                        </div>-->
                <!--                        <div class="tweet-content" style="font-size: 17px;">-->
                <!--                            564645645646-->
                <!--                        </div>-->
                <!--                        <div  :body-style="{ padding: '0px' }" style="background-color:#F7F7F7;padding-bottom: 5px" >-->
                <!--                            <div class="input" >-->
                <!--                                <div class="tweet-user-info">-->
                <!--                                    <div class="tweet-user-name" style="margin-left: 42px">-->
                ...
                <!--                            </div>-->
                <!--                        </div>-->
                <!--                        <div class="tweet-bottom" style="margin-top: 20px;color: #99a2aa;">-->
                <!--                            <div class="icon"><img src="../../styles/分享.png" height="20" width="20"/>转发</div>-->
                ...
                <!--                            <div class="icon"><img src="../../styles/删除.png" height="20" width="20"/>删除</div>-->
                <!--                        </div>-->
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            getData(id){
                this.$axios.get('/getUserWeibo',{ params: {
            ...
            send(){
                ...
                this.$axios.post('/sendWeibo',params).then(successResponse =>{
                    if (successResponse.data.code===200){
                        ...
                        this.getData(this.currentUserId)
                    }
                    else{
